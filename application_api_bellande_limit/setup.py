...
if ros_version == "1":
    ...
    setup(
        name="application_api_bellande_limit",
        version="0.1.0",
        packages=[],
        package_dir={"": "src"},
        py_modules=["bellande_limit_api"],
        data_files=[
            (
                os.path.join("share", "application_api_bellande_limit", "config", "json"),
        ...
        description="Bellande ROS/ROS2 package with a JSON config file for making HTTP requests for Bellande Limit",
        license="GPL-3.0",
    )
