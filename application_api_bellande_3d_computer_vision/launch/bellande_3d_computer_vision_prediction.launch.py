...
def ros1_launch_description():
    ...
    roslaunch_command = ["roslaunch", "application_api_bellande_3d_computer_vision", "bellande_3d_computer_vision_prediction.launch"] + args
    ...
    roslaunch_command.extend([
        "application_api_bellande_3d_computer_vision", "bellande_3d_computer_vision_prediction.py", "name:=pointcloud_prediction_node"
    ])
